...
export default async function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-white">
      <TrackPageView universe="horlogerie" productId={id} event="view_product" />
      {/* Breadcrumb */}
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-3 mt-auto">
              {product.stock > 0 && product.vinted_url ? (
                <VintedButton href={product.vinted_url} productId={id} universe="horlogerie" title={product.title} />
              ) : (
              ...
              <ServiceLink
                ...
                serviceType="repair"
                productId={id}
                className="w-full py-3 px-6 rounded-xl font-semibold text-base transition bg-amber-50 text-amber-800 hover:bg-amber-100 text-center flex items-center justify-center gap-2 border border-amber-200"
              >
