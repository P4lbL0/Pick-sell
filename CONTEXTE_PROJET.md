...
- **Heure réelle** : les aiguilles affichent l'heure de l'appareil. La trotteuse avance par 8 battements/seconde (cadence d'un mouvement mécanique, 28 800 A/h), donc 8 images/s au lieu de 60. Tout s'arrête quand l'onglet est caché ou la montre sortie de l'écran. Les aiguilles sont gravées dans la pose vitrine 10 h 10 : le décalage est **mesuré au chargement** sur la géométrie, un ré-export Blender dans une autre pose n'a donc rien à casser. Le quantième du guichet reste celui gravé dans le modèle.
...
| 2026-09-19 | **Montre à l'heure** : les aiguilles du configurateur donnent l'heure réelle, trotteuse à 8 battements/seconde, rendu suspendu onglet caché / montre hors écran | `src/components/configurateur/Visionneuse.tsx` |
